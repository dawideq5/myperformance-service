...
const CLIENTS = [
  ...
  { sort: 11, name: "Postal",                slug: "postal",               category: "admin",       fqdn: "https://newsletter.myperformance.pl",         icon: "Mail",         keycloak_client_id: "postal",           sso_enabled: true,  required_roles: ["postal_admin"]               },
