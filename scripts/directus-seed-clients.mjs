...
const CLIENTS = [
  ...
  { sort:  5, name: "Panel serwisanta",      slug: "panel-serwisanta",     category: "panel",       fqdn: "https://panelserwisanta.myperformance.pl",    icon: "Wrench",       keycloak_client_id: "panel-serwisant",   sso_enabled: true,  required_roles: ["serwisant", "serwisant_admin"]   },
  { sort:  6, name: "Panel kierowcy",        slug: "panel-kierowcy",       category: "panel",       fqdn: "https://panelkierowcy.myperformance.pl",      icon: "Truck",        keycloak_client_id: "panel-kierowca",    sso_enabled: true,  required_roles: ["kierowca", "kierowca_admin"]     },
  ...
  { sort: 10, name: "Chatwoot — administracja", slug: "chatwoot-admin",    category: "admin",       fqdn: "https://chat.myperformance.pl",               icon: "MessageSquare", keycloak_client_id: "chatwoot",        sso_enabled: true,  required_roles: ["chatwoot_admin"]             },
  { sort: 11, name: "Listmonk",              slug: "listmonk",             category: "admin",       fqdn: "https://newsletter.myperformance.pl",         icon: "Mail",         keycloak_client_id: "usesend",          sso_enabled: false, required_roles: ["usesend_admin"]              },
