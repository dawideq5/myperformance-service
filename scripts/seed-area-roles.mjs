...
const AREA_ROLES = [
  ...
  { name: "documenso_admin", description: "Administrator Documenso — szablony, webhooki, użytkownicy." },
  { name: "knowledge_user", description: "Dostęp do wiki (czytanie + pisanie)." },
  { name: "knowledge_admin", description: "Administrator Outline (kolekcje, użytkownicy, integracje)." },
  { name: "postal_admin", description: "Administrator Postal (serwery, domeny, polityki)." },
