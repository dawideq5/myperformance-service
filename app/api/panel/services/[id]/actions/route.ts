...
import { listServiceActions } from "@/lib/service-actions";
...
export async function GET(
  ...
  const actions = await listServiceActions(id);
  return NextResponse.json({ actions }, { headers: PANEL_CORS_HEADERS });
}
