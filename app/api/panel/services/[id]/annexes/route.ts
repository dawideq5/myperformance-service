...
import { listServiceAnnexes } from "@/lib/service-annexes";
...
export async function GET(
  ...
  const annexes = await listServiceAnnexes(id);
  return NextResponse.json({ annexes }, { headers: PANEL_CORS_HEADERS });
}
