...
| `postal/docker-compose.yml` | Postal (web + smtp + worker) + MariaDB transactional mail server. Subdomain `newsletter.myperformance.pl`. SMTP ports 25/465/587 via explicit host port bindings. | Coolify Service. |
