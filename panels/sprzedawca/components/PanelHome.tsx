...
export function PanelHome({
      ...
      >
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: "var(--text-muted)" }}>
            ...
            sprzedaży. Skontaktuj się z administratorem aby przypisać Cię
  ...
  return (
    ...
    <div
      ...
      style={{ background: "var(--bg-main)" }}
    >
      {/* Sub-header z aktywnym punktem (TopBar globalny w layout.tsx). Pokazuje
          nazwę punktu + opcjonalny "Zmień punkt" gdy >1 lokalizacja. */}
      <div
        className="border-b"
        style={{
